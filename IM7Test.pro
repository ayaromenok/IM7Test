...
#arm64-v8a  armeabi  armeabi-v7a  mips  mips64  x86  x86_64
    contains(ANDROID_TARGET_ARCH,armeabi-v7a) {
        ...
        LIBS += -L$${IM7ANDROID}/libs/armeabi-v7a
        ANDROID_EXTRA_LIBS = \
            $${IM7ANDROID}/libs/armeabi-v7a/libMagickCore-7.so \
            $${IM7ANDROID}/libs/armeabi-v7a/libMagickWand-7.so
    }
    contains(ANDROID_TARGET_ARCH,x86) {
        message("Android/x86")
        LIBS += -L$${IM7ANDROID}/libs/x86
        ANDROID_EXTRA_LIBS = \
            $${IM7ANDROID}/libs/x86/libMagickCore-7.so \
            $${IM7ANDROID}/libs/x86/libMagickWand-7.so
    }
