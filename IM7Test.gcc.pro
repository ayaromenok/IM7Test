...
#arm64-v8a  armeabi  armeabi-v7a  mips  mips64  x86  x86_64
    contains(ANDROID_TARGET_ARCH,armeabi-v7a) {
        message("Android/armv7/gcc")
        TARGET = IM7Test_armv7_gcc
    ...
    contains(ANDROID_TARGET_ARCH,x86) {
        message("Android/x86/gcc")
        TARGET = IM7Test_x86_gcc
    ...
    contains(ANDROID_TARGET_ARCH,arm64-v8a) {
        message("Android/arm64-v8a/gcc")
        TARGET = IM7Test_arm64_gcc
        LIBPATHARMV8_64 +=$${IM7ANDROID}/libs.gcc/arm64-v8a
    ...
    contains(ANDROID_TARGET_ARCH,x86_64) {
        message("Android/x86_64/gcc")
        TARGET = IM7Test_amd64_gcc
